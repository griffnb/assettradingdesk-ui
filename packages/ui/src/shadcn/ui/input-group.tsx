  ...
  return (
    <div
      ...
      className={cn([
        ...
        /* Focus State */
        "has-[[data-slot=input-group-control]:focus-visible]:border-neutral-950 has-[[data-slot=input-group-control]:focus-visible]:ring has-[[data-slot=input-group-control]:focus-visible]:ring-neutral-950/50",
        /* Error State */
