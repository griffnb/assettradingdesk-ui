    ...
    >
      ...
      {Array.from({ length: _values.length }, (_, index) => (
        <SliderPrimitive.Thumb
          ...
          key={index}
          className=" ring-neutral-950/50 block size-4 shrink-0 rounded-full border border-neutral-200 bg-white shadow-sm transition-[color,box-shadow] hover:ring-4 focus-visible:ring-4 focus-visible:outline-hidden disabled:pointer-events-none disabled:opacity-50  dark:ring-neutral-300/50 dark:border-neutral-800"
        />
      ))}
    </SliderPrimitive.Root>
  );
